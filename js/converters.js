...
(function() {
  ...
  var converters = function() {
    ...
    var byteArrayToHexString = function(bytes) {
      var str = '';
    ...
    var hexStringToByteArray = function(str) {
      var bytes = [];
      var i = 0;
      if (0 !== str.length % 2) {
    ...
    var stringToHexString = function(str) {
      return this.byteArrayToHexString(this.stringToByteArray(str));
    }

    var hexStringToString = function(hex) {
      return this.byteArrayToString(this.hexStringToByteArray(hex));
    }

    var checkBytesToIntInput = function(bytes, numBytes, opt_startIndex) {
    ...
    var byteArrayToSignedShort = function(bytes, opt_startIndex) {
    ...
    var byteArrayToSignedInt32 = function(bytes, opt_startIndex) {
    ...
    var byteArrayToBigInteger = function(bytes, opt_startIndex) {
    ...
    var wordArrayToByteArray = function(wordArray) {
      return wordArrayToByteArrayImpl(wordArray, true);
    }

    var wordArrayToByteArrayImpl = function(wordArray, isFirstByteHasSign) {
    ...
    var byteArrayToString = function(bytes, opt_startIndex, length) {
      if (length == 0) {
        return "";
      }
    ...
    var byteArrayToShortArray = function(byteArray) {
    ...
    var shortArrayToByteArray = function(shortArray) {
    ...
    var shortArrayToHexString = function(ary) {
      var res = "";
     ...
     */
    var intToBytes_ = function(x, numBytes, unsignedMax, opt_bigEndian) {
    ...
    var int32ToBytes = function(x, opt_bigEndian) {
      return intToBytes_(x, 4, 4294967295, opt_bigEndian);
    }

    var int16ToBytes = function(x, opt_bigEndian) {
      return intToBytes_(x, 2, 65535, opt_bigEndian);
    }

    var longToBytes = function(value){
     ...
     */
    var wordArrayToByteArrayEx = function(wordArray) {
      // Shortcuts
     ...
     */
    var byteArrayToWordArrayEx = function(u8arr) {
      // Shortcut
    ...
    return {
      ...
      wordArrayToByteArrayEx: wordArrayToByteArrayEx,
      byteArrayToWordArrayEx: byteArrayToWordArrayEx
    }
  }

  var app = angular.module('walletApp')
  app.service('converters', converters)
