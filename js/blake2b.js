// Blake2B Cryptography implementation in pure Javascript
...
(function() {
  var blake2b = function() {
    ...
    var compute = function(input, key, outlen) {
      // preprocess inputs
      outlen = outlen || 64
    ...
    // - key - optional key Uint8Array, up to 64 bytes
    // - outlen - optional output length in bytes, default 64
    var computeHex = function(input, key, outlen) {
      return toHex(this.compute(input, key, outlen))
    }

    return{
      compute: compute,
      computeHex: computeHex
    }

  }

  var app = angular.module('walletApp')
  app.service('blake2b', blake2b)
