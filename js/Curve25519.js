...
(function() {
  ...
  var Curve25519 = function() {
    var sharedKey = function(secretKey, publicKey) {
    ...
    var signMessage = function(secretKey, msg, opt_random) {
    ...
    var openMessage = function(publicKey, signedMsg) {
    ...
    var sign = function(secretKey, msg, opt_random) {
    ...
    var verify = function(publicKey, msg, signature) {
    ...
    var generateKeyPair = function(seed) {
  ...
  angular.module('walletApp').service('Curve25519', Curve25519)
