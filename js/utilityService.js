(function () {
    ...
    angular
        .module('walletApp')
        .service('utilityService', ['constants.network', 'cryptoService', 'converters', function (constants, cryptoService, converters) {
            var self = this;
            ...
            self.stringToByteArray = function(string){
              return converters.stringToByteArray(string);
            };
